---
name: claude-skills-reviewer
description: Claude Code スキルをベストプラクティスに照らして包括的にレビューし、具体的な改善提案を提供する。スキルの品質、構造、発見可能性、効率性を7つの観点から評価し、A-F評価とスコアを算出する。ユーザーが「スキルをレビュー」「スキルをチェック」「ベストプラクティスに従っているか確認」「スキルの品質評価」などを依頼した時に使用する
---
